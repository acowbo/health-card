  ...
  function HealthCard(props) {
    ...
    return e('div', {
      style: {
        ...
        boxShadow: '0 8px 24px rgba(244,63,94,0.04)',
      }
    },
      /* 顶部细彩条 */
      ...
      e('div', { style: { padding: '12px 14px 10px' } },
        ...
        e('div', { style: { display:'flex', alignItems:'center', gap:'8px', marginBottom:'12px' } },
          ...
          e('div', { style: { fontSize:'13px', fontWeight:700, color: theme.accent, letterSpacing:'0.2px' } }, '瘦得漂亮 · 健康摘要'),
        ...
        e('div', { style: { marginTop:'8px', textAlign:'right' } },
          e('span', { style: { fontSize:'10px', color:'#9CA3AF', letterSpacing:'0.5px' } }, 'AI · 仅供参考')
        )
      )
    );
  }
